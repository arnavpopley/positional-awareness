...
| `uv run pos deploy` | Publish the snapshot to the existing Vercel project (`positional-awareness`, URL `temporary-snappy-tuba-wtrnk56.vercel.app`) behind `PA_SITE_PASSWORD`. Snapshot, not live. Does not mint a new URL. |
