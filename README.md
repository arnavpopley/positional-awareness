...
| `uv run pos deploy` | Publish the snapshot to the existing Vercel project (`temporary-snappy-tuba-wtrnk56`) behind `PA_SITE_PASSWORD`. Snapshot, not live. Does not mint a new URL. |
