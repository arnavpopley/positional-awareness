...
| `uv run pos deploy` | Publish the password-gated book to Vercel project `positional-awareness` (URL `temporary-snappy-tuba-wtrnk56.vercel.app`). Thesis/S are a snapshot; qty/CMP poll Groww. |
